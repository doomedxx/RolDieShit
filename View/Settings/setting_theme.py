...
class themewidget(object):
    ...
    def __init__(self):
        ...
        self.themeLabel.config(text="THEME", font=value.titleFont, bg="gray30", fg=value.titleColor)
        self.themeLabel.pack()
        self.themeLabel.place(x=40, y=1)

        self.themeTip = Label(self.themeWidget)
        self.themeTip.config(text=self.tooltip, font=value.tipFont, bg="gray30", fg=value.titleColor)
        self.themeTip.pack()
        self.themeTip.place(x=5, y=28)

        self.themeDark = Button(self.themeWidget)
        self.themeDark.config(text="Dark Theme", font=value.titleFont, bg="gray40", fg=value.titleColor, borderwidth= 1, relief="raised")
        ...
        self.themeLight.config(text="Light Theme", font=value.titleFont, bg="gray40", fg=value.titleColor, borderwidth= 1, relief="raised")
    ...
    def addBlock(self):
        ...
        self.themeWidget.config(bg="gray30",borderwidth= value.borderWidth, relief=value.relief)

    def setTooltip(self, tip):
        self.themeTip.config(text=tip, font=value.tipFont, bg="gray30", fg=value.tipColor)
